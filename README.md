...
![Broker Slow Rate](img/broker_slow_rate_v2.png)
...
![Broker Demurrage](img/broker_demurrage_v2.png)
...
![Broker Comparison](img/broker_comparison_v2.png)
...
```
![Port Clearance time image](img/port_clearance_time_v2.png)

Average clearance time by port of entry – ordered from fastest to slowest.

![Boxplot for port performance](img/port_boxplot_ordered_v2.png)
...
```
![Image showing HS Risk Analysis](img/hs_risk_score_v2.png)
...
![Image showing the valuation discrepancy per broker](img/valuation_discrepancy_horizontal_v2.png)
